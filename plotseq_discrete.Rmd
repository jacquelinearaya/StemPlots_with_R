...
knitr::opts_chunk$set(echo = TRUE, results= 'hide',warning=FALSE, message = FALSE, cache=TRUE, tidy=TRUE)
library(tidyverse)
library(ggplot2)
```
...
```{python ex1, fig.width=10, fig.height=7, fig.align='center'}
...
```{r matlab, results='markup', fig.align="center", fig.cap="Matlab stem plot", fig.width=11, fig.height=9}
...
```{r usingggplot, fig.width=6, fig.height=4, fig.align='center'}
#generate same data
...
```{python ex2, fig.width=12, fig.height=6.5, fig.align='center'}
import matplotlib.pyplot as plt
import numpy as np
...
```{r ex3, fig.width=12, fig.height=7, fig.align='center'}
#Data sequences
